...
import { Form, Input,Row, Col, Button, InputNumber,DatePicker,Checkbox,Select,Spin,TimePicker, TreeSelect ,Tree,Radio, Tooltip   } from 'antd';
 ...
 */
  ...
  getDisplayValue = (col)=> {
    ...
    if (value && String(value).length > 20) {
      return  <Tooltip title={value}>{String(value).substr(0,17)}...</Tooltip>
    }
    return value;
  }
//======================= Page connected end ====================================
