	...
	<div class="block" width="100%">
		<el-form ref="form" :model="fwParam.newData" :rules="rules" label-position="right" label-width="100px" size="mini" @submit.native.prevent>
			 <el-form-item label="导出范围">
				<el-radio-group v-model="fwParam.pageRange">
				<el-radio label="0">全部</el-radio>
				<el-radio label="1">当前页</el-radio>
				</el-radio-group>
			</el-form-item>
			 <el-form-item label="导出格式">
				<el-radio-group v-model="fwParam.exportType">
				<el-radio label="XLS">Excel</el-radio>
				</el-radio-group>
			</el-form-item>
			<el-form-item label="导出列">
				<el-transfer v-model="selectedColumns" :data="columns" :titles="['待选列','已选列']"></el-transfer>
			</el-form-item>
			<el-form-item>
