	...
	var getDataFunction = function(view, data, actionIndex, rowIndex, successCallback) {
		...
		got.ajax({
			...
			success : function(returnData) {
				...
				var parentTreeColumn = view.treeParentIdField;
				console.info(parentTreeColumn);
				if (parentTreeColumn) {
					var singleData = {};
					singleData[parentTreeColumn] = $(view.getId("treeSelectedId")).val();
				...
				$(view.getId(dialogName)).dialog({
					...
					buttons : [ {
						...
						handler : function() {
							...
							if (!view.treeCanAddRoot && got.isEmpty(newData[view.treeParentIdField])) {
