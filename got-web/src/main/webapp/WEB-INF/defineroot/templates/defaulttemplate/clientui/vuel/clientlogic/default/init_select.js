function(vue, data, actionIndex, rowIndex, event) {
	var view = this;
	view.loading = true;
	view.$http.post('getSelectData',{fwCoord:view.fwCoord, fwPage:view.fwPage, fwParam:view.fwParam},{emulateJSON: true}).then(function(res){
		view.loading = false;
		...
		view.fwParam.oldListData = selectedRows;
