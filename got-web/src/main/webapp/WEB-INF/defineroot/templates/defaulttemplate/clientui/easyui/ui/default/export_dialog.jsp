...
<jsp:include page="../grid_button_area.jsp" />
			...
			<table width="99%" cellpadding="0" cellspacing="5">
				...
				<tr><td colspan="3">
<input type="radio" group="exportPageRange" id="${pageId }_pageRange_all" name="pageRange" value="0" checked>全部</input>
<input type="radio" group="exportPageRange" id="${pageId }_pageRange_current_page" name="pageRange" value="1">当前页</input>
				<hr>
				</td></tr>
				<tr>
				<td colspan="3">
				...
				<tr><td colspan="3">
<input type="radio" group="exportFileType" id="${pageId }_exportType_xls" name="exportType" value="XLS" checked>Excel</input>
<!-- 
<input type="radio" group="exportFileType" id="${pageId }_exportType_doc" name="exportType" value="DOC">Word</input>
<input type="radio" group="exportFileType" id="${pageId }_exportType_pdf" name="exportType" value="PDF">PDF</input>
 -->
				<hr>
				</td></tr>
				<tr>
				...
				<td width="50%" valign="top">
					<table id="${pageId}_fromDatagrid" width="100%" style="height: ${not empty view.height?(view.height - 200):200}px;">
...
<td>
	${instance.label }
				...
				<td width="50%" valign="top">
					<table id="${pageId}_toDatagrid" width="100%" style="height: ${not empty view.height?(view.height - 200):200}px;">
