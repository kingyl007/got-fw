...
<body class="hold-transition skin-lgreen-light sidebar-mini">
									...
									<ul class="treeview-menu">
										<c:forEach var="subAct" items="${act.children}"
											...
											<li type="menuContainer"><a id="${subAct.id}" href="#"
												...
												url="getView?fwCoord.project=${(empty subAct.argument.map['project'])?view.coord.project:subAct.argument.map['project'] }&fwCoord.function=${subAct.argument.map['function']}&fwCoord.lang=${view.coord.lang}&fwCoord.ui=${view.coord.ui}">
													<i
	...
	function postChangePassword() {
		...
		var postData = {'OLD_PASSWORD':$(view.getId('OLD_PASSWORD')).val(), 'NEW_PASSWORD' : $(view.getId('NEW_PASSWORD')).val()}; 
